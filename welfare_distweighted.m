...
for si=[1 2]
        ...
        weight1d=(exp(dij(24,index_)')/1000)/sum(exp(dij(24,index_)')/1000);
        weight2d=(exp(dij(25,index_)')/1000)/sum(exp(dij(25,index_)')/1000);
        weight3d=(weight1d+weight2d)/2;
        ...
        hatV(bi,si,di,:)= sum(hatV_1(:,:).*[weight3d weight3d]).*(1./theta);

        hatU(bi,si,di,:)= sum(hatU_2(:,:).*[weight3d weight3d]).*(1./theta);
...
%disp('Table 3 - Rows IV')
Table3(4,:)=new_welfare2_sig0(1,:);
Table3(14,:)=new_welfare2_sig1(1,:);
